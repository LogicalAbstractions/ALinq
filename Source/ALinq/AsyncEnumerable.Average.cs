...
namespace ALinq
{
    public static partial class AsyncEnumerable
    {
        ...
        {
            return (await AverageCore(enumerable,0, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / (int?)counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable,0L, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable,0.0f, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable,0.0, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable,0.0m, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable.Select(selector),0,(current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / (int?)counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable.Select(selector),0L, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable.Select(selector),0.0f, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable.Select(selector),0.0, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return (await AverageCore(enumerable.Select(selector),0.0m, (current, next) => next.HasValue ? current + next.Value : current, (sum, counter) => sum / counter)).Value;
        }
        ...
        {
            return await AverageCore<T>(enumerable, default(T), sumFunction, averageFunction);
        }
